export default function LegalClinicAbout() {
  return (
    <section data-reveal className="px-gutter max-w-3xl mx-auto py-12 sm:py-16 text-center">
      <h2 className="font-display text-2xl sm:text-3xl font-bold text-primary mb-6">
        Apa itu Legal Clinic di Kalih Signature?
      </h2>
